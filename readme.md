...
<img src="./images/maze00.jpg" alt="before" style="width: 47%; float: left; margin-right=10px">
...
2- resize the maze into 400 pixel by 400 pixel
3-
...
For this we have to read maze block by block 
   ...
   when maze is on the left   then Edge = 20 =1
            ...
            when maze is on the right then Edge = 22=4   
